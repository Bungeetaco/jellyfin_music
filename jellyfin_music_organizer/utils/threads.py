...
class ThreadManager:
    ...
    def start_thread(self, name: str, target: Callable, args: tuple = (), kwargs: Dict[str, Any] = None) -> None:
        """
        Start a new thread.
    ...
    def _thread_wrapper(self, name: str, target: Callable, args: tuple, kwargs: Dict[str, Any]) -> None:
        """
